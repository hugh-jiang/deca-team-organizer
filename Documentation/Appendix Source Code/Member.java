...
public class Member {
    ...
    public boolean equals(Member m) {
        ...
        if (firstName.equals(m.getFirstName()) && lastName.equals(m.getLastname()) && email.equals(m.getEmail()) && grade == m.getGrade() && subteam.equals(m.getSubteam()) && eventID.equals(m.getEventID())) {
            equals = true;
        }
        return equals;
    }
